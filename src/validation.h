...
static const int64_t DEFAULT_MAX_TIP_AGE = 365 * 24 * 60 * 60; // from 24 * 60 * 60
/** Maximum age of our tip in seconds for us to be considered current for fee estimation */
static const int64_t MAX_FEE_ESTIMATION_TIP_AGE = 3 * 60 * 60;

/** Default for -permitbaremultisig */
static const bool DEFAULT_PERMIT_BAREMULTISIG = false; // from true
static const bool DEFAULT_CHECKPOINTS_ENABLED = false; // from true
