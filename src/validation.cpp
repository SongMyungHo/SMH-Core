...
#if defined(NDEBUG)
# error "SongMyungHo cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "SongMyungHo Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SMH additional fees, %d delta bytes\n",
