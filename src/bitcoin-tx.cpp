...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s songmyungho-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  songmyungho-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded songmyungho transaction") + "\n" +
              "  songmyungho-tx [options] -create [commands]   " + _("Create hex-encoded songmyungho transaction") + "\n" +
              "\n";
